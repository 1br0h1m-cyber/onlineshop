      ...
      <div className='lg:w-1/2 px-3 pb-3'>
        ...
        <div className='flex gap-9 my-3'>
          ...
          <div className='flex gap-3'>
            <button className='border-solid border-blue-200 border-[2px] text-blue-200 rounded-md h-10 w-10 flex justify-center items-center text-[25px] hover:text-blue-400 hover:border-blue-400 hover:bg-sky-900 transition'><FaInstagram/></button>
            <button className='border-solid border-blue-200 border-[2px] text-blue-200 rounded-md h-10 w-10 flex justify-center items-center text-[25px] hover:text-blue-400 hover:border-blue-400 hover:bg-sky-900 transition'><LiaTelegramPlane/></button>
            <button className='border-solid border-blue-200 border-[2px] text-blue-200 rounded-md h-10 w-10 flex justify-center items-center text-[25px] hover:text-blue-400 hover:border-blue-400 hover:bg-sky-900 transition'><FaXTwitter/></button>
          </div>
        </div>
