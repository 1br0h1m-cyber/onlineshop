      ...
      <footer class="bg-slate-800">
          <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
              <div class="sm:flex sm:flex-col sm:items-center sm:justify-between md:flex-row md:justify-between" id='footerDiv'>
                  ...
                  <a href="https://flowbite.com/" class="flex items-center mb-4 sm:mb-6 px-6 py-1 sm:p-0 md:mb-0 space-x-3 rtl:space-x-reverse">
                      <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo" />
                      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
                  </a>

                <div className='grid grid-cols-2 space-x-[100px] md:space-x-[0px] md:gap-[0px] md:none justify-between' id='footer'>

                  <ul class="flex flex-col md:flex-row items-start sm:items-start md:items-center font-medium text-gray-400 space-y-4 md:space-y-0 md:space-x-9">
                      <li>
              ...
              <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:text-blue-400">Flowbite™</a>. All Rights Reserved.</span>
          </div>
      </footer>
